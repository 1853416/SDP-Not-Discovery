...
btnEnter.addEventListener('click', e => {
  ...
  .then((docSnapshot) => {
    ...
    Doctordata=docSnapshot.data();
        ...
        sendEmail(Doctordata['Email'],Doctordata['FirstName'])
       });
    } else {
...
function sendEmail(emailaddy,pname) {
  ...
  Body : "Good Day Dr. " +Doctordata['LastName']+ ","+"<br>" +  "<br>" +  "<br>" +  "Your password reset code is: "+"<br>"+Code
  ...
  setTimeout(function() {
    window.location.replace("../html/docforgotpasscode.html");
  }, delayInMilliseconds);
