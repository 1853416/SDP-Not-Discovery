...
var firebaseConfig = {
  ...
  function register () {
    ...
    if (validate_field(first_name) == false ||validate_field(last_name) == false || validate_field(idNum) == false || validate_field(Occupation) == false || validate_field(years) == false ||validate_field(qualifications) == false ) {
    ...
    .then(function() {
      ...
      database_ref.child('doctors/' + user.uid).set(user_data)
  ...
  function login () {
    ...
    .then(function() {
      ...
      // Push to Firebase Database
      database_ref.child('doctors/' + user.uid).update(user_data)
